...
public class ViewHabitDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String habitTitle = MainActivity.habitController.getTitle();
        String habitReason = MainActivity.habitController.getReason();


        SimpleDateFormat format = new SimpleDateFormat("dd-MM-yyyy");
        String dateText = format.format(MainActivity.habitController.getStartDate());

        double habitPercent = MainActivity.habitController.getPercentageCompletion();
        String percentText = Double.toString(floor(habitPercent*100)) + "%";
        if (percentText.equals("-100.0%")){
            percentText = "N/A";
        }
        int complete = MainActivity.habitController.getCompleted();
        int fail = MainActivity.habitController.getFailed();
            ...
            public void onClick(View view) {
                ...
                alert.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        MainActivity.habitController.deleteHabit();
                        dialog.dismiss();
                        finish();
                    }
                });

...
public class EditHabitActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        days = MainActivity.habitController.getDays();
        String oldName = MainActivity.habitController.getTitle();
        String oldReason = MainActivity.habitController.getReason();
        Date oldDate = MainActivity.habitController.getStartDate();
        ...
        doneButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view){
                ...
                if(MainActivity.eventList.getSize() > 0) {
                    earliestEventDate = MainActivity.eventList.getEvent(0).getDate();
                    for (HabitEvent event : MainActivity.eventList.getList()){
                ...
                for(int i = 0; i < MainActivity.habitList.getSize(); i++){
                    String valueID = MainActivity.habitList.getHabit(i).getTitle();
                    String ID = MainActivity.habitList.getHabit(i).getId();
                    if(valueID.equals(name.getText().toString()) && ! MainActivity.habitController.getID().equals(ID)){
    ...
    public void editHabitDone(){
        try{
            ...
            MainActivity.habitController.setTitle(habitName);
            MainActivity.habitController.setReason(habitReason);
            MainActivity.habitController.setDays(days);
            MainActivity.habitController.setDate(startDate);
            MainActivity.habitController.saveEditHabit();

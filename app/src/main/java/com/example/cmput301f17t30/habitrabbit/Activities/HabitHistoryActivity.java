...
public class HabitHistoryActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapterList.addAll(MainActivity.eventList.getList());
    ...
    public boolean onPrepareOptionsMenu(Menu menu) {
        ...
        String username = MainActivity.userController.getUsername();
    ...
    public void filterHistoryList(String filterString, Integer filterType){
        ...
        if (filterType == -1){
            habitEventadapter = new HabitHistoryLayoutAdapter(MainActivity.eventList.getList(), this);
            habitEventrecyclerView.setAdapter(habitEventadapter);
            habitEventadapter.notifyDataSetChanged();
        }
            ...
            for (int i = 0; i< MainActivity.habitList.getSize(); i++) {
                String habitID;
                Habit habit = MainActivity.habitList.getHabit(i);
    ...
    public void onBackPressed() {
        if(filter == Boolean.FALSE){
            ...
            getEventTask.execute(MainActivity.userController.getUsername());
        }
    }
